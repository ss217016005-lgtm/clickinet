...
// --- כל מאות השאלות המקוריות של הזירה המשפחתית ---
const defaultArenaQuestions = {
    family: [
        { q: "מי במשפחה תמיד קם ראשון בשבת בבוקר?", a: "המשכים המשפחתי" }, { q: "מי הכי סביר שייצא מהבית ויחזור כי הוא שכח משהו?", a: "המפוזר/ת המקסים/ה" }, { q: "מהו המאכל שכולם מחכים לו בערב שבת?", a: "המנה המנצחת של הבית" }, { q: "מי במשפחה הכי מצחיק כשמישהו קצת עצוב?", a: "המעודד/ת הרשמי/ת" }, { q: "מי במשפחה זקוק להכי הרבה שעות שינה?", a: "הישנוני/ת של הבית" }, { q: "מהו המשפט שיוצא לאבא הכי הרבה פעמים מהפה?", a: "משפט המפתח של אבא" }, { q: "מי הכי בשלן במשפחה (חוץ מאמא)?", a: "השף/ית הסודי/ת" }, { q: "מי במשפחה תמיד מאחר ב-5 דקות לכל תפילה או אירוע?", a: "זה שחי לפי שעון משלו" }, { q: "מהו השיר או הניגון שתמיד מזכיר לכם את הבית?", a: "ההמנון המשפחתי" }, { q: "מי הכי טכנולוגי במשפחה ועוזר לכולם עם מכשירים?", a: "מוקד התמיכה האנושי" }, { q: "מה הצבע של המזוזה בכניסה לבית?", a: "תסתכלו בדלת" }, { q: "מי הכי סביר שייקח איתו מזוודה ענקית לנסיעה של יומיים?", a: "זה שמתכונן לכל תרחיש" }, { q: "כמה חלונות יש בבית?", a: "הגיע הזמן לבדוק" }, { q: "מי במשפחה תמיד יודע איפה נמצאים המפתחות של כולם?", a: "בעל/ת עיני הרנטגן" }, { q: "מי הכי סביר שייצא מהבית עם גרביים לא תואמות?", a: "המפוזר/ת" }, { q: "מי הכי סביר שיחזור מהמכולת עם דברים שלא היו ברשימה?", a: "חובב המבצעים" }, { q: "איזה סיפור או ספר קראתם/שמעתם הכי הרבה פעמים?", a: "הקלאסיקה המשפחתית" }, { q: "מי הכי סביר שיתחיל לשיר באמצע הליכה ברחוב?", a: "הזמר/ת של הבית" }, { q: "מהו המנהג המיוחד שקיים רק במשפחה שלכם?", a: "המסורת הסודית שלנו" }, { q: "מי הכי אחראי בבית על הסדר והניקיון?", a: "שוטר/ת הסדר" }, { q: "נכון או לא נכון: במגירת התבלינים יש תבלין שלא השתמשו בו שנה.", a: "מבחן הניקיון של פסח" }, { q: "נכון או לא נכון: יש לכם בבית חפץ ששייך לסבא או סבתא.", a: "מבחן המורשת" }, { q: "נכון או לא נכון: הידית של הברז במטבח פונה שמאלה כשסוגרים אותה.", a: "מבחן הדיוק" }, { q: "מה הדבר הראשון שרוב בני המשפחה עושים כשהם נכנסים הביתה?", a: "חליצת נעליים / נטילת ידיים" }, { q: "מי במשפחה הכי פוחד מג'וקים או מחרקים?", a: "זה שבורח ראשון מהחדר" }, { q: "איזו תכונה אחת מאפיינת את המשפחה שלכם יותר מהכל?", a: "שמחה / עזרה / הכנסת אורחים" }, { q: "מה הצבע של המגבת שתלויה כרגע במטבח?", a: "מבחן הזיכרון לטווח קצר" }, { q: "מי הכי אוהב לדבר בטלפון שעות ארוכות?", a: "הדובר/ת הרשמי/ת" }, { q: "מהו החפץ הכי יקר שיש בבית?", a: "זה נמצא בכספת" }, { q: "איך קוראים לבן דוד הכי צעיר במשפחה?", a: "אולי אפילו עוד לא קראו לו שם" }, { q: "מהי המילה שמשתמשים בה הכי הרבה בתוך הבית?", a: "מילת המפתח המשפחתית" }, { q: "מי הכי סביר שיתנדב ראשון לעזור לשכן שזקוק לעזרה?", a: "איש/אשת החסד" }, { q: "כמה חבילות טישו פותחים בבית לפני שבת?", a: "לשאול את אבא" }, { q: "מי במשפחה הכי אוהב להתחדש בבגדים?", a: "חובב/ת האופנה" }, { q: "מה הדבר שהכי מעצבן את אמא (בצחוק)?", a: "זהירות... לא לעשות את זה" }, { q: "מי הכי סביר שישכח איפה הוא קשר את האופניים או חנה?", a: "הנווט/ת המבולבל/ת" }, { q: "מהי המתנה הכי יפה שמישהו קיבל מהמשפחה?", a: "משהו שנשאר למזכרת" }, { q: "מי במשפחה הכי פחות אוהב לקום בבוקר?", a: "טיפוס של לילה" }, { q: "מה הדבר שכולכם הכי אוהבים לעשות בצהרי יום שישי?", a: "מנוחה / טעימות מהסירים" }, { q: "מי הכי סביר שיגמור את החטיפים בלילה?", a: "גנב/ת הממתקים" }, { q: "איזו תחפושת פורים היתה הכי מוצלחת במשפחה אי פעם?", a: "התחפושת המנצחת" }, { q: "מי במשפחה תמיד מצלם את כולם באירועים?", a: "הצלם/ת המשפחתי/ת" }, { q: "כמה כיסאות בסך הכל יש בבית (כולל מתקפלים)?", a: "מי סופר אורחים?" }, { q: "מי במשפחה הכי אוהב טבע ובעלי חיים?", a: "חובב/ת הבריאה" }, { q: "מהו החפץ הכי עתיק בבית שעדיין נמצא בשימוש?", a: "הרהיט או הכלי של פעם" }, { q: "מי הכי סביר שינצח בתחרות אכילה?", a: "התיאבון הבריא של הבית" }, { q: "מה היה מעשה הקונדס הכי גדול שאחד הילדים עשה פעם?", a: "סיפור הבלאגן הגדול" }, { q: "באיזה צבע המברשת שיניים של אמא?", a: "הגיע הזמן לבדוק" }, { q: "מהו הדבר שכולכם מסכימים עליו פה אחד בלי ויכוח?", a: "הקונצנזוס המשפחתי" }, { q: "איזה חפץ אם ינסו לתקן אותו רק ישבר יותר?", a: "האגרטל/חפץ אחר" }, { q: "מהו המשקה שבלעדיו אי אפשר לסיים סעודה בבית?", a: "קפה / תה / מיץ" }, { q: "מי נמצא הראשון בממד או במקלט?", a: "הזריז" }, { q: "מי במשפחה יש לו את הכתב הכי יפה ומסודר?", a: "הסופר/ת שלנו" }
    ],
    nature: [
        { q: "איזו חיה ישנה בעמידה?", a: "סוס או פיל" }, { q: "מהו העץ הלאומי של ישראל?", a: "זית" }, { q: "איזו ציפור היא הגדולה ביותר בעולם?", a: "יען" }, { q: "איזה יונק הוא היחיד שמסוגל לעוף?", a: "עטלף" }, { q: "מהו הדג המהיר ביותר באוקיינוס?", a: "מפרשן (Sailfish)" }, { q: "איזה בעל חיים מחליף את צבעו כדי להסתוות?", a: "זיקית (או תמנון)" }, { q: "מהו היונק הגדול ביותר בעולם?", a: "לווייתן כחול" }, { q: "איזו חיה ידועה כ'ספינת המדבר'?", a: "גמל" }, { q: "איפה נמצאות השיניים של החילזון?", a: "על הלשון שלו" }, { q: "כמה לבבות יש לתמנון?", a: "3" }, { q: "מהו סוג הדם של תמנון?", a: "כחול" }, { q: "איזו ציפור מסוגלת לעוף אחורנית?", a: "קוליברי (צופית)" }, { q: "איזה בעל חיים לא יכול לקפוץ?", a: "פיל" }, { q: "איזה נחש הוא הארוך ביותר בעולם?", a: "פיתון מרושת" }, { q: "מהו הגז הנפוץ ביותר באטמוספירה של כדור הארץ?", a: "חנקן" }, { q: "איך קוראים לקבוצת כוכבים שיוצרת צורה בשמיים?", a: "קונסטלציה (מזל)" }, { q: "איזה כוכב לכת הכי קרוב לשמש?", a: "חמה (מרקורי)" }, { q: "כמה ימים לוקח לכדור הארץ להקיף את השמש?", a: "365 ורבע (שנה)" }, { q: "מהו המדבר הגדול ביותר בעולם?", a: "אנטארקטיקה (או סהרה)" }, { q: "איזו מדינה נחשבת לביתם של הכי הרבה קנגורו?", a: "אוסטרליה" }, { q: "מהו ההר הגבוה ביותר בעולם?", a: "האוורסט" }, { q: "איזה נהר הוא הארוך ביותר בעולם?", a: "הנילוס (או האמזונס)" }, { q: "איך קוראים לסלע מותך שנמצא בתוך הר געש?", a: "מאגמה" }, { q: "מהו החומר הקשה ביותר שנמצא בטבע?", a: "יהלום" }, { q: "איזה בעל חיים ישן עם עין אחת פקוחה?", a: "דולפין" }, { q: "מהי הציפור הלאומית של ישראל?", a: "דוכיפת" }, { q: "כמה זמן לוקח לאור השמש להגיע לכדור הארץ?", a: "כ-8 דקות" }, { q: "מה מיוחד בעץ 'הסקויה'?", a: "העץ הגבוה ביותר בעולם" }, { q: "איזה חוש הכי מפותח אצל כלבים?", a: "חוש הריח" }, { q: "מהי החיה המהירה ביותר על פני היבשה?", a: "ברדלס (צ'יטה)" }, { q: "איזו קבוצת בעלי חיים מטילה ביצים אבל מניקה חלב?", a: "יונקי ביב (כמו הברווזן)" }, { q: "כמה עצמות יש בגוף של כריש?", a: "0 (השלד עשוי מסחוס)" }, { q: "איך דבורים מתקשרות זו עם זו?", a: "באמצעות 'ריקוד'" }, { q: "איזה יונק ימי ידוע בשירה שלו?", a: "לווייתן גדול-סנפיר" }, { q: "מה שמו של המקום הכי עמוק באוקיינוס?", a: "שקע מריאנה" }, { q: "מהו בעל החיים שחי הכי הרבה שנים?", a: "מדוזה מסוג מסוים (אלמותית) או כריש גרינלנד" }, { q: "איך קוראים לתהליך שבו זחל הופך לפרפר?", a: "גלגול מלא" }, { q: "איזה חלק בפרח מושך אליו דבורים?", a: "עלי הכותרת" }, { q: "מהו פרי הדר?", a: "תפוז, לימון, אשכולית וכו'" }, { q: "מאיזה עץ מפיקים שעם?", a: "אלון השעם" }
    ],
    general: [
        { q: "איזה חודש בלוח העברי תמיד מונה 29 ימים?", a: "טבת (או תמוז/אלול)" }, { q: "כמה שעות יש בשבוע שלם?", a: "168 שעות" }, { q: "מי המציא את נורת החשמל?", a: "תומאס אדיסון" }, { q: "באיזו עיר נמצאים קברי אבות האומה?", a: "חברון (מערת המכפלה)" }, { q: "כמה ברכות יש בתפילת עמידה של חול?", a: "19" }, { q: "מהי המדינה הגדולה ביותר בעולם בשטחה?", a: "רוסיה" }, { q: "כמה כוכבי לכת יש במערכת השמש שלנו?", a: "8" }, { q: "איזה ים נמצא בנקודה הנמוכה ביותר בעולם?", a: "ים המלח" }, { q: "מהו הסמל הכימי של זהב?", a: "Au" }, { q: "מי כתב את 'מסילת ישרים'?", a: "הרמח\"ל" }, { q: "באיזו עיר בעולם נמצא ה'ביג בן'?", a: "לונדון" }, { q: "איזה יסוד מסומן באות O?", a: "חמצן" }, { q: "מהו האוקיינוס הגדול ביותר?", a: "האוקיינוס השקט" }, { q: "מי המציא את מכשיר הטלפון הראשון?", a: "אלכסנדר גרהם בל" }, { q: "איזו מדינה באירופה מזכירה בצורתה מגף?", a: "איטליה" }, { q: "מהו השם שניתן ליחידה הבסיסית ביותר של כל יצור חי?", a: "תא" }, { q: "כמה שיניים יש לאדם בוגר בדרך כלל?", a: "32" }, { q: "באיזו עיר בעולם נמצא מגדל אייפל?", a: "פריז" }, { q: "מהי הטמפרטורה שבה מים רותחים?", a: "100 מעלות צלזיוס" }, { q: "איזה חודש לועזי הוא הקצר ביותר?", a: "פברואר" }, { q: "מהו שמו של המבצר העתיק ליד שער יפו בירושלים?", a: "מגדל דוד" }, { q: "מהו הצבע שמתקבל מערבוב כחול וצהוב?", a: "ירוק" }, { q: "באיזו יבשת נמצאות הפירמידות הגדולות?", a: "אפריקה" }, { q: "כמה שנים נמשכה גלות בבל הראשונה?", a: "70 שנה" }, { q: "איזה כוכב לכת מכונה 'הכוכב האדום'?", a: "מאדים" }, { q: "מי חיבר את הפיוט 'ידיד נפש'?", a: "רבי אלעזר אזכרי" }, { q: "מהי היבשת הקטנה ביותר בעולם?", a: "אוסטרליה" }, { q: "באיזו עיר בישראל נמצא מוסד ה'טכניון'?", a: "חיפה" }, { q: "מי המציא את כתב העיוורים?", a: "לואי ברייל" }, { q: "מהו הנהר הארוך ביותר בארץ ישראל?", a: "הירדן" }, { q: "איזו עיר בישראל ידועה כ'עיר המקובלים'?", a: "צפת" }, { q: "מאיזה חומר מפיקים את הגומי?", a: "שרף של עץ הגומי" }, { q: "כמה צבעים יש בקשת בענן?", a: "7" }, { q: "מהו המדבר הגדול ביותר בעולם?", a: "סהרה" }, { q: "באיזו שפה נכתב במקור ספר הכוזרי?", a: "ערבית יהודית" }, { q: "איזה איבר אחראי על ניקוי רעלים בדם?", a: "כבד" }, { q: "כמה יבשות יש בעולם?", a: "7" }, { q: "איזו עיר מכונה 'התפוח הגדול'?", a: "ניו יורק" }, { q: "מי המציא את המטוס הראשון?", a: "האחים רייט" }, { q: "כמה דקות יש ביממה שלמה?", a: "1,440 דקות" }
    ],
    funny: [
        { q: "מה יש לו שיניים אבל הוא לא יכול לנשוך?", a: "מסרק" }, { q: "מה נהיה רטוב יותר ככל שהוא מייבש יותר?", a: "מגבת" }, { q: "מה שייך לך, אבל כולם משתמשים בו הרבה יותר ממך?", a: "השם שלך" }, { q: "לאיזו שאלה אי אפשר לענות ב'כן'?", a: "האם אתה ישן עכשיו?" }, { q: "מה עולה ויורד אבל תמיד נשאר באותו מקום?", a: "מעלית" }, { q: "מה יש לו רגליים אבל הוא לא יכול ללכת?", a: "שולחן" }, { q: "איזה חודש בשנה יש בו 28 ימים?", a: "כולם!" }, { q: "מה נשבר ברגע שאומרים את השם שלו?", a: "שקט" }, { q: "מה מלא חורים אבל עדיין מחזיק מים?", a: "ספוג" }, { q: "מה יש לו עין אחת אבל הוא לא רואה כלום?", a: "מחט" }, { q: "מה חייבים לשבור לפני שמשתמשים בו?", a: "ביצה" }, { q: "לאיזה עץ אין עלים ואין ענפים?", a: "עץ משפחה" }, { q: "מה נכנס למים אדום ויוצא שחור?", a: "ברזל מלובן" }, { q: "מה רץ בכל הבית אבל אין לו רגליים?", a: "קירות / כביש" }, { q: "מה יש לו צוואר אבל אין לו ראש?", a: "בקבוק" }, { q: "מה הולך על ארבע בבוקר, על שתיים בצהריים ועל שלוש בערב?", a: "האדם (תינוק, מבוגר, זקן)" }, { q: "מה אפשר לתפוס אבל אי אפשר לזרוק?", a: "נזלת / צינון" }, { q: "מה נהיה קטן יותר בכל פעם שהוא מתרחץ?", a: "סבון" }, { q: "מה יש לו הרבה מילים אבל הוא אף פעם לא מדבר?", a: "ספר / מילון" }, { q: "מה הולך קדימה אבל משאיר עקבות אחורה?", a: "נעליים" }, { q: "מה עומד על רגל אחת והראש שלו בשמיים?", a: "פנס רחוב" }, { q: "מה יש לו אלף שערות והוא לא מתרחץ?", a: "מטאטא" }, { q: "מה אפשר להחזיק ביד ימין אבל אף פעם לא ביד שמאל?", a: "את מרפק שמאל" }, { q: "מה גדל למטה כשהוא גדל למעלה?", a: "נטיף קרח" }, { q: "איזה מפתח לא יכול לפתוח שום דלת?", a: "מפתח סול" }, { q: "מה יש לו לב אבל אין לו איברים אחרים?", a: "חבילת קלפים / ארטישוק" }, { q: "מי יכול לדבר בכל השפות בעולם?", a: "הד (Echo)" }, { q: "מה עולה אבל אף פעם לא יורד?", a: "הגיל שלך" }, { q: "מה יש לו ערים אבל אין לו בתים, הרים אבל אין לו עצים?", a: "מפה" }, { q: "מה נהיה ארוך כשמושכים אותו, וקצר כשמשתמשים בו?", a: "סיגריה / נר" }, { q: "איזו רכבת נוסעת בלי גלגלים ובלי פסים?", a: "רכבת מחשבות" }, { q: "למה האריה אכל את המנצח בתחרות?", a: "כי אמרו לו שהפרס זה ארוחה עם המנצח" }, { q: "מה משותף לעגבנייה ופיל?", a: "שניהם אדומים, חוץ מהפיל" }, { q: "מה יותר כבד - קילו ברזל או קילו נוצות?", a: "אותו משקל" }, { q: "איך אפשר לעבור את ים סוף בלי להירטב?", a: "בטיסה" }, { q: "מה נכנס דרך חלון סגור בלי לשבור אותו?", a: "אור השמש" }
    ]
};
...
try { 
    if (fs.existsSync(DB_PATH)) {
        ...
        if (data.trim() !== '') {
            ...
            // נוודא שיש שאלות - אם זה ריק לחלוטין, נטען את ברירת המחדל
            if(!db.arenaQuestions || !db.arenaQuestions.family || db.arenaQuestions.family.length === 0) {
...
io.on('connection', (socket) => {
    ...
    socket.on('updatePortalAd', ad => { if (ad.imgBase64) { const base64Data = ad.imgBase64.replace(/^data:image\/\w+;base64,/, ""); const fileName = 'ad_' + Date.now() + '.png'; fs.writeFileSync('uploads/' + fileName, base64Data, 'base64'); db.portalAd.img = '/uploads/' + fileName; } if (ad.link !== undefined) db.portalAd.link = ad.link; if (ad.clear) db.portalAd = {img: "", link: ""}; saveDB(); emitPortalData(); emitSuperData(); });
    ...
    socket.on('createVoucher', data => { 
        db.vouchers[data.code] = { type: data.type, days: parseInt(data.days), used: false, isPublic: data.isPublic || false, usesCount: 0, created: new Date().toLocaleDateString('he-IL') }; 
        saveDB(); emitSuperData(); 
    });
    ...
    socket.on('redeemVoucher', code => { 
        ...
        if(v && (!v.used || v.isPublic)) { 
            ...
            if (v.isPublic) { v.usesCount = (v.usesCount || 0) + 1; } else { v.used = true; v.generatedPin = newPin; }
...
http.listen(PORT, '0.0.0.0', () => console.log("=== Clickinet V67.1 (All Questions Restored) is ONLINE ==="));
